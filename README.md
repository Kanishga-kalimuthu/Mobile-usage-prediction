...
An interactive dashboard is developed using Streamlit along with Pandas and Plotly, allowing users to filter and explore the data easily.
This project can also be extended to predict future mobile usage patterns.
